...
const ProfessionalSummaryForm = ({data , onChange , setResumeData}) => {
  return (
    ...
    <div className='mt-6'>
        ...
        focus:border-blue-500 outline-none transition-colors resize-none' placeholder='Write a compelling professional summary that highlights your
        key strengths and career objectives...'/>

        <p className='text-xs text-gray-500 max-w-4/5 mx-auto text-center'> Tip: keep it concise (3-4 sentences) and focus on your most relevant achiebements and skills.</p>
    </div>
