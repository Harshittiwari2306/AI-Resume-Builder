...
const TemplateSelector = ({selectedTemplate , onChange}) => {
  ...
  return (
    <div className='relative'>
      <button onClick={()=>setIsOpen(!isOpen)} className='flex item-center gap-1 text-sm text-blue-600 bg-gradient-to-br from-blue-50 to-blue-100 ring-blue-300 hover:ring
