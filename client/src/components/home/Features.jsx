...
const Features = () => {
    ...
    return (
        <div id='features' className='flex flex-col items-center my-10 scroll-mt-12'>
            ...
            <Title title='Build your resume' description={`An AI-driven resume builder designed to simplify resume creation by generating
             content, improving clarity, and formatting everything into a clean, professional design.`}/>
